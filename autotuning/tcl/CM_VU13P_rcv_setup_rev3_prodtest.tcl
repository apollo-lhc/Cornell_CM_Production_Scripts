...
cfg::parse_file $dir/../config_rev3_prodtest.ini

#source /nfs/cms/tracktrigger/ad683/Cornell_CM_Production_Scripts/autotuning/config_parser.tcl   CHECK IF THE ABOVE REPLACES THIS!!!!
