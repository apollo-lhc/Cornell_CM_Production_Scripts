...
# Load init
config = ConfigParser()
config.read('config_rev3_prodtest.ini')
...
mgt_rx = mgt_rx_0_1 + mgt_rx_1_1 + mgt_rx_0to1 + mgt_rx_1to0
mgt_tx = mgt_tx_0_1 + mgt_tx_1_1 + mgt_tx_0to1 + mgt_tx_1to0
...
for mgt_idx in range(len(mgt_rx)):
    ...
    elif mgt_idx >= len(mgt_rx_0_1 + mgt_rx_1_1) and mgt_idx < len(mgt_rx_0_1 + mgt_rx_1_1 + mgt_rx_0to1):
